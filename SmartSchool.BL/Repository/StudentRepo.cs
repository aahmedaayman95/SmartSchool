...
namespace SmartSchool.BL.Repository
{
    public class StudentRepo : IStudentRepo
    {
        ...
        {
            var students = Db.Students.Where(s => s.AbsenceDays >= s.MaxDayOff).Include(s => s.ClassRoom).Select(s => new StudentVM()
            {
                Id = s.Id,
                AbsenceDays = s.AbsenceDays,
                Address = s.Address,
        ...
        {
            var myStudent = Db.Students.Where(r => r.IdentityUserId == identity).Select(s => new StudentVM()
            {
                Id = s.Id,
                AbsenceDays = s.AbsenceDays,
                Address = s.Address,
        ...
        {
            var parentchilds = Db.Students.Where(s => s.ParentID == id).Select(s => new StudentVM()
            {
                Id = s.Id,
                AbsenceDays = s.AbsenceDays,
                Address = s.Address,
